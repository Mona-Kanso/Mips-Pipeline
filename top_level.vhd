...
-- Module Name:    processador_pipeline - Behavioral;
-- Description:    Top-level do processador, responsavel por integrar todos os componentes.
----------------------------------------------------------------------------------
...
architecture Structural of processador_pipeline is
